                  ...
                  <div class="space-y-5">
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                      ...
                      <div class="sm:col-span-1">
                        ...
                        <input v-model="formData.firstName" type="text" id="fname" name="fname" placeholder="Enter your first name" class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" required aria-required="true" aria-label="Enter first name" :aria-invalid="errors.firstName ? 'true' : 'false'" aria-describedby="first-name-error" autofocus @change="validateName"/>
                      </div>
                      <!-- Last Name -->
                      <div class="sm:col-span-1">
                        ...
                        <input v-model="formData.lastName" type="text" id="lname" name="lname" placeholder="Enter your last name" class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" aria-label="Enter last name" />
                      </div>
                    </div>
                    <!-- Email -->
                    <div>
                      ...
                      <input v-model="formData.email" type="email" id="email" name="email" placeholder="info@example.com" class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" required aria-required="true" aria-label="Enter email address" :aria-invalid="errors.email ? 'true' : 'false'" aria-describedby="email-error" @change="validateEmail" />
                    </div>
                    <!-- Password -->
                    <div>
...
const handleSubmit = async () => {
  ...
  try {
    await authStore.register(formData.firstName, formData.lastName, formData.email, formData.password);

    ...
    <div>
      <div class="mx-auto w-full max-w-[460px] text-center">
        <a href="/" class="inline-block mb-6">
          <img class="dark:hidden" src="/images/logo/logo.svg" alt="Logo" /><img class="hidden dark:block" src="/images/logo/logo.svg" alt="Logo" /></a>
        ...
        <div class="mb-10">
          ...
          <div class="text-base text-center text-gray-500 dark:text-gray-400">
            <div class="flex justify-center gap-0.5">
              <div>
                <span class="inline-block timer-box">
        ...
        <div class="flex flex-col gap-2 sm:flex-row sm:gap-3 justify-center">
